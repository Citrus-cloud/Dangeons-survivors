/* ============================================================
   sprites-expansion.js — Спрайты для расширения (50 врагов + 5 боссов).
   
   Генерирует процедурные спрайты для всех новых врагов из
   constants_expansion.js. Использует те же утилиты рисования,
   что и sprites-enemies.js.
   
   Загрузка: ПОСЛЕ sprites-enemies.js и constants_expansion.js
   
   Стилистика: тёмное фэнтези, минимум тяжёлых операций,
   каждый спрайт — уникальная визуальная идентичность.
   
   Экспорт: Добавляет спрайты в глобальный ENEMY_SPRITES{}
   ============================================================ */
