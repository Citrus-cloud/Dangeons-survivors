...
const CONFIG = {
  ...
  PLAYER: {
    ...
    SPEED: 90,              // Скорость движения (px/sec)
  ...
  POOLS: {
    ...
    PARTICLES: 200,         // Макс. частиц (увеличено для пула, лимит в MemoryOptimizer)
  ...
  /* 48dp = 48 * devicePixelRatio на мобильных; увеличен для удобства */
  JOYSTICK: {
    BASE_RADIUS: 48,        // Радиус основания джойстика (dp-единицы)
    STICK_RADIUS: 24,       // Радиус стика (dp-единицы)
    MAX_OFFSET: 56,         // Макс. отклонение стика от центра (px)
...
const ENEMY_TYPES = {
  ...
  archlich: {
    ...
    spawnWeight: 0.3, hitInterval: 0.8, wobble: 1.5,
  ...
  eldritch_horror: {
    ...
    spawnWeight: 0.3, hitInterval: 0.8, wobble: 0,
