'use strict';
/* ============================================================
   loot.js — Система лута: кристаллы опыта (XP) и золото.
   
   Назначение:
   • Создание и управление XP-кристаллами (зелёные, красные, синие, жёлтые)
   • Создание и управление золотыми монетками (мета-валюта)
   • Магнит — притяжение дропа к герою при приближении
   • Подбор — начисление XP/золота при касании
   ...
   │ Обычный  │ #44ff44 │ 5-15          │ 1       │ 100%  │
   └──────────┴─────────┴───────────────┴─────────┴───────┘
   
   Зависимости: CONFIG, Utils, Game, Player, MetaProgress
   Экспорт: window.{createXP, createGold, GOLD_CONFIG, Loot}
   ============================================================ */

/**
 * Фабрика XP-кристалла для ObjectPool.
...
/**
 * Фабрика золотой монетки для ObjectPool.
 * @returns {Object} Пустой объект монетки
 */
function createGold() {
...
/* ============================================================
   Конфигурация золота (мета-валюта для мета-прогресса)
   ============================================================ */
const GOLD_CONFIG = {
  DROP_CHANCE: 0.40,         // Шанс дропа с обычного врага (40%)
  DROP_MIN: 1,               // Мин. количество золота с обычного врага
  DROP_MAX: 3,               // Макс. количество золота с обычного врага
  ELITE_DROP_MIN: 5,         // Мин. с элитного врага
  ELITE_DROP_MAX: 10,        // Макс. с элитного врага
  BOSS_DROP_MIN: 50,         // Мин. с босса
  BOSS_DROP_MAX: 150,        // Макс. с босса
  RADIUS: 4,                 // Визуальный радиус монетки (px)
  POOL_SIZE: 50,             // Размер пула монеток
  MAGNET_SPEED: 360,         // Скорость притяжения к герою (px/sec)
};
