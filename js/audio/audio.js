'use strict';
/* ============================================================
   audio.js — Аудиосистема игры (Web Audio API).
   
   Содержит:
   • Генерация музыки для каждого биома (drone + мелодические ноты)
   • Звуковые эффекты (SFX): удары, смерти, левелап, боссы и т.д.
   • Настройки громкости (сохраняются в localStorage)
   • Аудио-эффекты: ADSR-огибающие, фильтры, реверберация, хорус
   
   Управление:
   • GameAudio.init() — Инициализация AudioContext
   • GameAudio.playMusic(biomeId) — Запуск фоновой музыки биома
   • GameAudio.playSfx(id) — Воспроизведение звукового эффекта
   • GameAudio.stopMusic() — Остановка музыки
   • GameAudio.pauseMusic() / resumeMusic() — Пауза/возобновление
   
   Экспорт: window.GameAudio
   ============================================================ */
